...
public abstract class MultiTouchObject implements Serializable {
    ...
    protected static final int DEFAULT_DELETE_BORDER_COLOR = Color.RED;
    ...
    protected boolean isSelectedForDeletion = false;
    ...
    protected boolean setPos(float centerX, float centerY,
        ...
        maxX = centerX + ws;
        maxY = centerY + hs;
        theX = centerX - (width / 2);
        theY = centerY - (height / 2);

        //Timber.d("MinX:%f MinY:%f", minX, minY);
    ...
    public void setSelectedForDeletion(boolean selected) {
        this.isSelectedForDeletion = selected;
        setSelected(selected);
        setBorderColor(DEFAULT_DELETE_BORDER_COLOR);
    }
